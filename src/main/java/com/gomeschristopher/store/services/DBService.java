...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Client cli1 = new Client(null, "Maria Silva", "nelio.cursos@gmail.com", "36378912377", ClientType.NATURAL_PERSON, pe.encode("123"));
		
		cli1.getPhones().addAll(Arrays.asList("27363323", "93838393"));
		
		Client cli2 = new Client(null, "Ana Costa", "nelio.iftm@gmail.com", "31628382740", ClientType.NATURAL_PERSON, pe.encode("123"));
		...
		Purchase ped1 = new Purchase(null, sdf.parse("30/09/2017 10:32"), cli1, e1);
		Purchase ped2 = new Purchase(null, sdf.parse("10/10/2017 19:35"), cli1, e2);
		
		Payment pagto1 = new PaymentCard(null, PaymentStatus.SETTLED, ped1, 6);
		ped1.setPayment(pagto1);
		
		Payment pagto2 = new PaymentBill(null, PaymentStatus.PENDING, ped2, sdf.parse("20/10/2017 00:00"), null);
		...
		purchaseItemRepository.saveAll(Arrays.asList(ip1, ip2, ip3));		
